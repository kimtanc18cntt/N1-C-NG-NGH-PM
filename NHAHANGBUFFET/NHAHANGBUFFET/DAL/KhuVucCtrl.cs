...
namespace NHAHANGBUFFET.DAL
{
    class KhuVucCtrl
    {
        public static DataSet FillDataSet_getKhuVucByIdKhuVuc(string _idKhuVuc)
        {
            try
            {
                BLL.KhuVucMod kvuc = new BLL.KhuVucMod(_idKhuVuc);
        ...
        public static int InsertKhuVuc(string _idKhuVuc, string _tenKhuVuc, string _dienGiai, string _trangThai)
        {
            try
            {
                BLL.KhuVucMod _khuvuc = new BLL.KhuVucMod(_idKhuVuc, _tenKhuVuc, _dienGiai, _trangThai);
        ...
        public static int DeleteKhuVuc(string _idKhuVuc)
        {
            try
            {
                BLL.KhuVucMod _khuvuc = new BLL.KhuVucMod(_idKhuVuc);
