...
namespace NHAHANGBUFFET.UI
{
    public partial class uctMonDaGoi : UserControl
    {
        ...
        {
            dgvGoiMon.DataSource = BLL.GoiMonMod.FillDataSetGoiMon().Tables[0];
        ...
        void loadcontrolBan()
        {
            cmbIdBan.DataSource = BLL.GoiMonMod.FillDataSet_getIdBan().Tables[0];
        ...
        void loadcontroThucDon()
        {
            ...
            cmbTenThucDon.DataSource = BLL.GoiMonMod.FillDataset_getDonGiaThucDon().Tables[0];
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (flag == 0)
            {
                ...
                {
                    int i = 0;
                    i = DAL.GoiMonCtrl.InSertGoiMon(_idBan, _tenThucDon, _donGia, _soLuong, _ThoiGian, _thanhTien);
                    if (i > 0)
                    {
            ...
            {
                int i = 0;
                i = DAL.GoiMonCtrl.UpdateGoiMon(_idBan, _tenThucDon, _donGia, _soLuong, _ThoiGian, _thanhTien);
                if (i > 0)
                {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                int i = 0;
                i = DAL.GoiMonCtrl.DeleteGoiMon(_idBan);
                if (i > 0)
                {
