...
namespace NHAHANGBUFFET.UI
{
    public partial class uctGoiMon : UserControl
    {
        ...
        public DataTable getBan()
        {
            ...
            dt = BLL.BanMod.FillDataSetDanhSachBan_GoiMon().Tables[0];
            return dt;
        ...
        {
            DataTable dt = new DataTable();
            dt = BLL.GoiMonMod.FillDataSetDanhSachBan_GoiMon().Tables[0];
        ...
        {
            DataTable dt = new DataTable();
            dt = BLL.GoiMonMod.FillDataSetDanhSachBan_ChuaGoiMon().Tables[0];
            dgvGoiMon.DataSource = dt;
            return dt;
        }
        ...
        private void lvDanhSachBan_Click(object sender, EventArgs e)
        {
            ...
            dgvGoiMon.DataSource = DAL.GoiMonCtrl.FillDataSet_getGoiMonByIdBan(_IdBan).Tables[0];
        ...
        private void btnTinhtien_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ok == DialogResult.Yes)
                {
                    ...
                    nhung(uctMDG);
                    string _IdBan = lvDanhSachBan.SelectedItems[0].SubItems[1].Text;
                    dgvGoiMon.DataSource = DAL.GoiMonCtrl.DeleteGoiMon(_IdBan);
                    uctGoiMon_Load(sender, e);
                }
                else
                {
